...
public class UpdateReq implements Serializable {
    ...
    /**
     *  Indicates the action by SHR (P95).
     *  <p>
     *      Constant Value : 7 (0x00000007)
     *  </p>
     */
    public static final int ACTION_SHR = 7;

    /**
     *  Indicates the action by CTLS (C150S).
     *  <p>
     *      Constant Value : 8 (0x00000008)
     *  </p>
     */
    public static final int ACTION_CTLS = 8; // RFU

    /**
     *  Indicates the action by SPED5 .
     *  <p>
     *      Constant Value : 9 (0x00000009)
     *  </p>
     */
    public static final int ACTION_SPED5 = 9; // RFU

    /**
     *  Indicates the action by KeyReader .
     *  <p>
     *      Constant Value : 10 (0x0000000a)
     *  </p>
     */
    public static final int ACTION_KEYREADER = 10; // RFU


    /**
     *  Indicates the update folder form usb disk.
     *  Only for android 4.4.2
     */
    @Deprecated
     ...
     */
    @Deprecated
    public UpdateReq(@NonNull String folderPath, @NonNull String fileName, boolean skipIfSameVer, boolean delSrcIfOk, int port){
     ...
     * @param fileName  The parameter is source file name.
     */
    public UpdateReq(@NonNull String folderPath, @NonNull String fileName){

        mFolder = folderPath;
        mTarget = fileName;
        mSkipIfSameVer = false;
        mDelSrcIfOk = false;
        mPort = -1;
    }
     ...
     * @param port Specific the target device port. Set to -1 to indicate the build-in default port number.
     */
    public UpdateReq(@NonNull String folderPath, @NonNull String fileName, int port){
     ...
     */
    public static UpdateReq getBundleData(@NonNull Bundle b) {
     ...
     */
    public static void setBundleData(@NonNull Bundle b, @NonNull UpdateReq updateMsg) {
