...
public class Misc
{
    ...
    /** The system root key status (locked or unlocked). */
    ...
    /** Indicates if export log success */
    public static final int EXPORTLOG_SUCCESS = 0;
    
    /** Indicates if export log when compress warnning */
    public static final int EXPORTLOG_COMPRESS_WATNNING = 1;
    
    /** Indicates if export log when compress fail */
    public static final int EXPORTLOG_COMPRESS_FAULT = 2;
    
    /** Indicates if export log when compress command error */
    public static final int EXPORTLOG_COMPRESS_COMMAND_ERROR = 7;
    
    /** Indicates if export log when compress memory error */
    public static final int EXPORTLOG_COMPRESS_MEMORY_ERROR = 8; 
    
    /** Indicates if export log get invalid path */
    public static final int EXPORTLOG_INVALID_PATH = 15;
    /** Indicates if export log get invalid path */
    public static final int EXPORTLOG_PARAMETER_ERROR = 16;
    /** Indicates if export log busy */
    public static final int EXPORTLOG_BUSY_ERROR = 17;        
    /** Indicates if export log user stop */ 
    public static final int EXPORTLOG_COMPRESS_USER_STOP = 255; 
    //	
    //	Methods
    //
    /**
     ...
     *     <tr><td>INFO_ROOTKEY_STATUS</td><td>The system root key status (locked or unlocked).</td></tr>
     ...
     * root to have full privileges to access this function.
     * <p>Remarks:<br />
